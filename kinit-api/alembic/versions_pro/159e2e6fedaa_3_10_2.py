...
Revision ID: 159e2e6fedaa
Revises: 142d8b19526b
Create Date: 2024-05-19 08:28:46.281539
...
revision = '159e2e6fedaa'
down_revision = '142d8b19526b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('platform_baseinfo_cookie', 'last_login_time',
               existing_type=mysql.DATETIME(),
               server_default=sa.text('now()'),
               existing_comment='最近访问时间',
               existing_nullable=False)
    op.alter_column('platform_baseinfo_cookie', 'create_datetime',
               existing_type=mysql.DATETIME(),
               server_default=sa.text('now()'),
               existing_comment='创建时间',
               existing_nullable=False)
    op.alter_column('platform_baseinfo_cookie', 'update_datetime',
               existing_type=mysql.DATETIME(),
               server_default=sa.text('now()'),
